...
```sh
root@quynv-redis01:~# apt install php libapache2-mod-php php-mysql -y
```
...
```sh
root@quynv-redis01:~# apt install -y php-curl php-gd php-mbstring php-xml php-xmlrpc php-soap php-intl php-zip
```
...
root@quynv-redis01:~# vim /etc/apache2/sites-available/000-default.conf 
